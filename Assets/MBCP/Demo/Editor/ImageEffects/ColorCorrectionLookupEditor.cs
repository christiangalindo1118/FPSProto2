        ...
        public override void OnInspectorGUI()
        {
            ...
            if (tex && (target as ColorCorrectionLookup).basedOnTempTex != AssetDatabase.GetAssetPath(tex))
            {
                ...
                else if (GUILayout.Button("Convert and Apply"))
                {
                    ...
                    // 🔧 CAMBIO CLAVE: usar textureCompression en lugar de textureFormat
                    ...
                    if (doImport)
                    {
                        ...
                        textureImporter.textureCompression = TextureImporterCompression.Uncompressed; // 👈 reemplazo moderno
